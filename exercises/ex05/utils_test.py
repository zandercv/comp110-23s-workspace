...
def test_diff_length() -> None: 
    #tests to see if concaten still works even when one list is longer than the other 
    test_list1: list[int] = [1, 2, 3]
...
def test_neg() -> None: 
    # Tests to see if sub can create a sublist which starts at index 0 when the starting index is less than 0 
